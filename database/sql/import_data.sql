...
-- =============================================
-- Limpa a tabela de demonstrações contábeis para uma nova importação (opcional, mas recomendado)
TRUNCATE TABLE demonstracoes_contabeis;
-- Remove tabelas temporárias de execuções anteriores
...
CREATE TABLE temp_demonstracoes (
    ...
    -- Usamos TEXT para aceitar vírgulas
    VL_SALDO_FINAL TEXT -- Usamos TEXT para aceitar vírgulas
);
-- Limpa a tabela de operadoras antes da importação (use com cautela se outras tabelas dependem dela)
TRUNCATE TABLE operadoras;
-- Importação da tabela de operadoras
COPY operadoras (
    Registro_ANS,
    CNPJ,
    Razao_Social,
...
FROM '/dados_ans/dados_cadastrais/Relatorio_cadop.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
-- ... restante do seu script de importação das demonstrações contábeis ...
...
FROM '/dados_ans/csv_demonstracoes/1T2023.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
FROM '/dados_ans/csv_demonstracoes/2T2023.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
FROM '/dados_ans/csv_demonstracoes/3T2023.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
FROM '/dados_ans/csv_demonstracoes/4T2023.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
FROM '/dados_ans/csv_demonstracoes/1T2024.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
FROM '/dados_ans/csv_demonstracoes/2T2024.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
FROM '/dados_ans/csv_demonstracoes/3T2024.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
...
FROM '/dados_ans/csv_demonstracoes/4T2024.csv' WITH (
        FORMAT CSV,
        HEADER TRUE,
        DELIMITER ';',
        ENCODING 'LATIN1'
